...
func main() {
	...
	router.GET("/about/me/", controller.AboutMeHandler)
	router.POST("/comment/submit/", controller.CommentSubmitHandler)
	router.POST("/leave/submit/", controller.LeaveSubmitHandler)
	_ = router.Run(":8080")
}
