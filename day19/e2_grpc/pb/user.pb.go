...
func (x *UserResponse) GetHobbies() []string {
	if x != nil {
		return x.Hobbies
	}
	return nil
...
var file_user_proto_rawDesc = []byte{
	...
	0x62, 0x69, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x68, 0x6f, 0x62, 0x62,
	0x69, 0x65, 0x73, 0x32, 0x43, 0x0a, 0x0f, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x30, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
	0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0f, 0x2e, 0x70, 0x62, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52,
...
var file_user_proto_depIdxs = []int32{
	0, // 0: pb.UserInfoService.GetUserInfo:input_type -> pb.UserRequest
	1, // 1: pb.UserInfoService.GetUserInfo:output_type -> pb.UserResponse
...
func (c *userInfoServiceClient) GetUserInfo(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.UserInfoService/GetUserInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserInfoService_GetUserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.UserInfoService/GetUserInfo",
	}
...
var _UserInfoService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pb.UserInfoService",
